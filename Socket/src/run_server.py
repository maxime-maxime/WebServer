...
@tracer
def start_server(config_data, routes_data, vm_lock, log_lock, php_config):
    ...
    while True:
        ...
        handler = HTTPHandler(client_info,config_data, routes_data,vm_lock,log_lock, php_config)
